...
python dna.py databases/large.csv sequences/5.txt
python dna.py databases/large.csv sequences/5.txt]\
python dna.py databases/large.csv sequences/5.txt]python dna.py databases/large.csv sequences/5.txt]python dna.py databases/large.csv sequences/5.txt]python dna.py databases/large.csv sequences/5.txt]
python dna.py databases/large.csv sequences/5.txt
python dna.py databases/large.csv sequences/5.txt
python dna.py databases/large.csv sequences/5.txt
python dna.py databases/large.csv sequences/5.txt
...
mkdir pset7
cd pset7
wget https://cdn.cs50.net/2019/fall/psets/7/movies/movies.zi
unzip movies.zip
...
python import.py
python import.py
python import.py 23232 3232
python import.py 232
python import.py 232
python import.py 232 2332
python import.py 232 2332
python import.py 232
python import.py 232
...
unzip finance.zip && rm finance.zip && cd finance && ls
