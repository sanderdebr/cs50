...
![Overview, AWS CDK Explorer](./resources/marketplace/cloud9/overview-cdk.png)

With the CDK explorer, you can navigate the CDK application's infrastructure stacks, resources, and policies.

![AWS CDK Tree View](./resources/marketplace/cloud9/cdk-tree-view.png)
...
![View Amazon EventBridge Schemas](./resources/marketplace/cloud9/eventbridge-search.png)
...
![Amazon ECS IntelliSense for Task Definition Files](./resources/marketplace/cloud9/ecs-task-def-intellisense.png)
...
![AWS Step Functions](./resources/marketplace/cloud9/sfn-state-machine.png)
...
![Command Palette](./resources/marketplace/cloud9/open-command-palette-codelens.gif)
